    ...
    <aside className="flex h-full w-[260px] shrink-0 flex-col bg-sidebar">
      ...
      <div className="flex flex-col gap-1.5 px-3 pb-1">
        ...
        >
          ...
          Open the wiki
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-auto text-text-3">
