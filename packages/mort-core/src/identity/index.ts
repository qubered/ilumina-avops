 ...
 *
 * Consumed by both the ingest authoring agent and the assistant's chat agent
 * (`@mort/core/agent`) — this is the one hoisted copy noted in the old
 * per-service comment here.
 */
